...
_COMPANIES_RAW: list[CompanyConfig] = [
    ...
    CompanyConfig("KIT.OL",   reporting_currency="EUR", full_name="Kitron ASA",
                  sector="Technology / Electronics Manufacturing",
                  notes="Electronics manufacturing services (EMS) for the medical devices, industrial, and defence/aerospace sectors. Plants across Norway, Sweden, Denmark, Lithuania, Poland, Czechia, China and the US. Changed presentation currency NOK→EUR in 2024; yfinance serves ALL historical columns in EUR (verified by magnitude 2026-08: 2022 revenue 641m ≈ NOK 6,585m at 2022 average rate), so the series is internally consistent."),
    ...
    CompanyConfig("PUBLI.OL", reporting_currency="SEK", full_name="Public Property Invest ASA",
                  sector="Real Estate",
                  notes="Redomiciling to Sweden; primary listing on Nasdaq Stockholm from May 2026, secondary listing on Oslo Børs continues. Reporting currency changed NOK→SEK with the redomicile; NOK/SEK ≈ 1.00 so historical magnitudes are near-identical. Verify one historical year against the restated comparatives in the first SEK annual report."),
